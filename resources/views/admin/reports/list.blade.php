                            ...
                            <div class="col text-truncate">
                                <div class="row text-truncate">
                                    <div class="col-12 col-lg-6 d-flex align-items-center text-truncate">
                                        <img src="https://icons.duckduckgo.com/ip3/{{ parse_url($report->fullUrl, PHP_URL_HOST) }}.ico" rel="noreferrer" class="width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}"> <div class="text-truncate" dir="ltr"><div class="text-truncate" data-tooltip="true" title="{{ $report->url }}"><a href="{{ route('admin.reports.edit', $report->id) }}" dir="ltr">{{ $report->url }}</a></div></div>
                                    </div>
