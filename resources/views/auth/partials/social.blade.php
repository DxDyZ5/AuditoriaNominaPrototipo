    ...
    <div class="row mx-n2 mt-2">
        @if(config('settings.auth_google'))
            <div class="col-12 col-md-6 p-2">
                <a href="{{ Socialite::with('google')->stateless()->redirect()->getTargetUrl() }}" class="btn btn-outline-secondary d-flex align-items-center justify-content-center w-100" rel="nofollow">
        ...
        @if(config('settings.auth_microsoft'))
            <div class="col-12 col-md-6 p-2">
                <a href="{{ Socialite::with('azure')->stateless()->redirect()->getTargetUrl() }}" class="btn btn-outline-secondary d-flex align-items-center justify-content-center w-100" rel="nofollow">
        ...
        @if(config('settings.auth_apple'))
            <div class="col-12 col-md-6 p-2">
                <a href="{{ Socialite::with('apple')->stateless()->redirect()->getTargetUrl() }}" class="btn btn-outline-secondary d-flex align-items-center justify-content-center w-100" rel="nofollow">
